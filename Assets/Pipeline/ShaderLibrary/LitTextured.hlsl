#ifndef PIPELINE_LIT_TEXTURED_INCLUDED
#define PIPELINE_LIT_TEXTURED_INCLUDED
...
float4 LitPassFragment(VertexOutput input) : SV_TARGET {
	...
	clip(int((1 - tex.a) * -1));
	float3 color = diffuseLight * albedo * tex.rgb;
	return float4(color, 1);
}

#endif // PIPELINE_LIT_TEXTURED_INCLUDED